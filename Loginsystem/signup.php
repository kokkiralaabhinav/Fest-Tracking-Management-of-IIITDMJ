...
if($row>0)
{
    ...
    $msg=mysqli_query($con,"insert into users(fname,lname,email,event,password,contactno) values('$fname','$lname','$email','$event','$password','$contact')");
...
<input class="form-control" id="email" name="email" type="email" placeholder="kokkiralaabhinav@gmail.com" required />
<label for="inputEmail">Email address</label>
</div>
 
<div class="form-floating mb-3">
<input class="form-control" id="event" name="event" type="event" required />
<label for="inputEvent">Event</label>
</div>

<div class="form-floating mb-3">
<input class="form-control" id="contact" name="contact" type="text" placeholder="9110776420" required pattern="[0-9]{10}" title="10 numeric characters only"  maxlength="10" required />
...
<div class="d-grid"><button type="submit" class="btn btn-primary btn-block" name="submit">Create Account</button></div>
 ...
 <div class="small"><a href="login.php">Have an account? Go to login</a></div>
  <div class="small"><a href="index.php">Back to Rigerster,login and admin panel Drashboard</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
